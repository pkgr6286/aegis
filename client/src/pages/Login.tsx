...
const PHARMA_COMPANIES: CompanyAccounts[] = [
  {
    ...
    editor: { role: 'Editor', email: 'cynthia.marvin@kenvue.com', name: 'Cynthia Marvin', icon: Edit, color: 'text-cyan-500' },
    viewer: { role: 'Viewer', email: 'kathleen.considine@kenvue.com', name: 'Kathleen Considine', icon: Eye, color: 'text-slate-500' },
    clinician: { role: 'Clinician', email: 'buddy.schaefer@kenvue.com', name: 'Buddy Schaefer', icon: Stethoscope, color: 'text-green-500' },
    auditor: { role: 'Auditor', email: 'keara.torphy@kenvue.com', name: 'Keara Torphy', icon: ClipboardCheck, color: 'text-orange-500' },
  },
  {
    company: 'Haleon',
    admin: { role: 'Admin', email: 'sarah.mitchell@haleon.com', name: 'Sarah Mitchell', icon: UserCog, color: 'text-blue-500' },
    editor: { role: 'Editor', email: 'maxie.farrell@haleon.com', name: 'Maxie Farrell', icon: Edit, color: 'text-cyan-500' },
    viewer: { role: 'Viewer', email: 'alvena.grant@haleon.com', name: 'Alvena Grant', icon: Eye, color: 'text-slate-500' },
    clinician: { role: 'Clinician', email: 'leonardo.lebsack@haleon.com', name: 'Leonardo Lebsack', icon: Stethoscope, color: 'text-green-500' },
    auditor: { role: 'Auditor', email: 'kathryne.baumbach@haleon.com', name: 'Kathryne Baumbach', icon: ClipboardCheck, color: 'text-orange-500' },
  },
  {
    company: 'Pfizer',
    admin: { role: 'Admin', email: 'michael.thompson@pfizer.com', name: 'Michael Thompson', icon: UserCog, color: 'text-blue-500' },
    editor: { role: 'Editor', email: 'camden.schulist@pfizer.com', name: 'Camden Schulist', icon: Edit, color: 'text-cyan-500' },
    viewer: { role: 'Viewer', email: 'tara.rempel@pfizer.com', name: 'Tara Rempel', icon: Eye, color: 'text-slate-500' },
    clinician: { role: 'Clinician', email: 'polly.dicki@pfizer.com', name: 'Polly Dicki', icon: Stethoscope, color: 'text-green-500' },
    auditor: { role: 'Auditor', email: 'demario.leuschke@pfizer.com', name: 'Demario Leuschke', icon: ClipboardCheck, color: 'text-orange-500' },
  },
  {
    company: 'Sanofi',
    admin: { role: 'Admin', email: 'jennifer.rodriguez@sanofi.com', name: 'Jennifer Rodriguez', icon: UserCog, color: 'text-blue-500' },
    editor: { role: 'Editor', email: 'jennings.klocko@sanofi.com', name: 'Jennings Klocko', icon: Edit, color: 'text-cyan-500' },
    viewer: { role: 'Viewer', email: 'alice.kuphal@sanofi.com', name: 'Alice Kuphal', icon: Eye, color: 'text-slate-500' },
    clinician: { role: 'Clinician', email: 'samanta.mckenzie@sanofi.com', name: 'Samanta McKenzie', icon: Stethoscope, color: 'text-green-500' },
    auditor: { role: 'Auditor', email: 'marcos.mann@sanofi.com', name: 'Marcos Mann', icon: ClipboardCheck, color: 'text-orange-500' },
  },
  {
    company: 'AstraZeneca',
    admin: { role: 'Admin', email: 'david.chen@astrazeneca.com', name: 'David Chen', icon: UserCog, color: 'text-blue-500' },
    editor: { role: 'Editor', email: 'eleonore.klocko@astrazeneca.com', name: 'Eleonore Klocko', icon: Edit, color: 'text-cyan-500' },
    viewer: { role: 'Viewer', email: 'catalina.runolfsdottir@astrazeneca.com', name: 'Catalina Runolfsdottir', icon: Eye, color: 'text-slate-500' },
    clinician: { role: 'Clinician', email: 'brady.davis@astrazeneca.com', name: 'Brady Davis', icon: Stethoscope, color: 'text-green-500' },
    auditor: { role: 'Auditor', email: 'dagmar.hyatt-beier@astrazeneca.com', name: 'Dagmar Hyatt-Beier', icon: ClipboardCheck, color: 'text-orange-500' },
  },
  {
    company: 'Merck',
    admin: { role: 'Admin', email: 'emily.johnson@merck.com', name: 'Emily Johnson', icon: UserCog, color: 'text-blue-500' },
    editor: { role: 'Editor', email: 'mallory.kertzmann@merck.com', name: 'Mallory Kertzmann', icon: Edit, color: 'text-cyan-500' },
    viewer: { role: 'Viewer', email: 'emilia.gislason@merck.com', name: 'Emilia Gislason', icon: Eye, color: 'text-slate-500' },
    clinician: { role: 'Clinician', email: 'alphonso.schroeder@merck.com', name: 'Alphonso Schroeder', icon: Stethoscope, color: 'text-green-500' },
    auditor: { role: 'Auditor', email: 'blanche.russel@merck.com', name: 'Blanche Russel', icon: ClipboardCheck, color: 'text-orange-500' },
  },
  {
    company: 'Eli Lilly',
    admin: { role: 'Admin', email: 'robert.williams@lilly.com', name: 'Robert Williams', icon: UserCog, color: 'text-blue-500' },
    editor: { role: 'Editor', email: 'haleigh.waters@lilly.com', name: 'Haleigh Waters', icon: Edit, color: 'text-cyan-500' },
    viewer: { role: 'Viewer', email: 'baron.thiel@lilly.com', name: 'Baron Thiel', icon: Eye, color: 'text-slate-500' },
    clinician: { role: 'Clinician', email: 'dario.legros@lilly.com', name: 'Dario Legros', icon: Stethoscope, color: 'text-green-500' },
    auditor: { role: 'Auditor', email: 'clovis.weimann@lilly.com', name: 'Clovis Weimann', icon: ClipboardCheck, color: 'text-orange-500' },
  },
  {
    company: 'Bayer',
    admin: { role: 'Admin', email: 'catherine.anderson@bayer.com', name: 'Catherine Anderson', icon: UserCog, color: 'text-blue-500' },
    editor: { role: 'Editor', email: 'gregg.cronin@bayer.com', name: 'Gregg Cronin', icon: Edit, color: 'text-cyan-500' },
    viewer: { role: 'Viewer', email: 'danika.schinner@bayer.com', name: 'Danika Schinner', icon: Eye, color: 'text-slate-500' },
    clinician: { role: 'Clinician', email: 'clementine.paucek@bayer.com', name: 'Clementine Paucek', icon: Stethoscope, color: 'text-green-500' },
    auditor: { role: 'Auditor', email: 'della.bartoletti@bayer.com', name: 'Della Bartoletti', icon: ClipboardCheck, color: 'text-orange-500' },
  },
  {
    company: 'AbbVie',
    admin: { role: 'Admin', email: 'thomas.martin@abbvie.com', name: 'Thomas Martin', icon: UserCog, color: 'text-blue-500' },
    editor: { role: 'Editor', email: 'verlie.bergstrom@abbvie.com', name: 'Verlie Bergstrom', icon: Edit, color: 'text-cyan-500' },
    viewer: { role: 'Viewer', email: 'vincenzo.kuhn@abbvie.com', name: 'Vincenzo Kuhn', icon: Eye, color: 'text-slate-500' },
    clinician: { role: 'Clinician', email: 'libbie.medhurst@abbvie.com', name: 'Libbie Medhurst', icon: Stethoscope, color: 'text-green-500' },
    auditor: { role: 'Auditor', email: 'albin.grimes@abbvie.com', name: 'Albin Grimes', icon: ClipboardCheck, color: 'text-orange-500' },
  },
  {
    company: 'P&G Health',
    admin: { role: 'Admin', email: 'maria.garcia@pghealth.com', name: 'Maria Garcia', icon: UserCog, color: 'text-blue-500' },
    editor: { role: 'Editor', email: 'ramona.mayert@pghealth.com', name: 'Ramona Mayert', icon: Edit, color: 'text-cyan-500' },
    viewer: { role: 'Viewer', email: 'aiyana.johnson@pghealth.com', name: 'Aiyana Johnson', icon: Eye, color: 'text-slate-500' },
    clinician: { role: 'Clinician', email: 'roberta.rutherford@pghealth.com', name: 'Roberta Rutherford', icon: Stethoscope, color: 'text-green-500' },
    auditor: { role: 'Auditor', email: 'vernie.schaefer@pghealth.com', name: 'Vernie Schaefer', icon: ClipboardCheck, color: 'text-orange-500' },
  },
];
